<template>
  ...
  const response = await fetch(`https://45.55.126.45:8001/api/admin/unverified?page=${page}`, { headers });
  ...
  const response = await fetch(`https://45.55.126.45:8001/api/admin/${id}/accept`, {
  method: 'PUT',
  headers,
